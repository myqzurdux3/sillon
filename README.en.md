...
<p align="center">
  ...
  <img alt="164 JVM tests" src="https://img.shields.io/badge/JVM%20tests-164-FF4D2E">
  <img alt="14 instrumented tests" src="https://img.shields.io/badge/instrumented%20tests-14-FF4D2E">
...
network: each is reported and spoken. Conflating the two would run a whole commute grading
everything "again", without a word of explanation.
...
The app listens in French. Grades: « à revoir », « difficile », « bien », « facile ».
Navigation: « répète », « passe », « explique », « stop ». Going back: « reviens » opens a
parenthesis on the previous card — regrade it or ask for an explanation — then the current
question is read again, so you never lose your place.
...
```bash
./gradlew :core:test               # 164 tests, no Android
